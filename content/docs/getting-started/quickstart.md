---
title: "Quickstart"
description: "Build a complete RAG pipeline in under 50 lines of Rust — embed, store, retrieve, and answer, all against local services."
weight: 3
keywords: [quickstart, RAG pipeline, local RAG, air-gapped RAG, Rust AI]
